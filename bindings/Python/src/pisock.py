...
def pi_getsockname(pi_sd, remote_addr, namelen):
    return _pisock.pi_getsockname(pi_sd, remote_addr, namelen)

def pi_getsockpeer(pi_sd, remote_addr, namelen):
    return _pisock.pi_getsockpeer(pi_sd, remote_addr, namelen)
...
def pi_accept(pi_sd, remote_addr, namelen):
    return _pisock.pi_accept(pi_sd, remote_addr, namelen)

def pi_accept_to(pi_sd, remote_addr, namelen, timeout):
    return _pisock.pi_accept_to(pi_sd, remote_addr, namelen, timeout)
...
def pi_write(pi_sd, databuf, datasize):
    return _pisock.pi_write(pi_sd, databuf, datasize)
...
def dlp_ReadStorageInfo(sd, cardno, cardinfo):
    return _pisock.dlp_ReadStorageInfo(sd, cardno, cardinfo)

def dlp_ReadUserInfo(sd, user):
    return _pisock.dlp_ReadUserInfo(sd, user)
...
def dlp_ReadNetSyncInfo(sd, OUTPUT):
    return _pisock.dlp_ReadNetSyncInfo(sd, OUTPUT)
...
def dlp_CallApplication(sd, creator, type, action, datasize, databuf):
    return _pisock.dlp_CallApplication(sd, creator, type, action, datasize, databuf)
...
def dlp_WriteAppPreference(sd, creator, prefid, backup, version, databuf, datasize):
    return _pisock.dlp_WriteAppPreference(sd, creator, prefid, backup, version, databuf, datasize)
...
def dlp_FindDBByName(sd, cardno, dbname, dbInfo, dbSize):
    return _pisock.dlp_FindDBByName(sd, cardno, dbname, dbInfo, dbSize)

def dlp_FindDBByOpenHandle(sd, dbhandle, dbInfo, dbSize):
    return _pisock.dlp_FindDBByOpenHandle(sd, dbhandle, dbInfo, dbSize)

def dlp_FindDBByTypeCreator(sd, type, creator, start, latest, dbInfo, dbSize):
    return _pisock.dlp_FindDBByTypeCreator(sd, type, creator, start, latest, dbInfo, dbSize)
...
def dlp_WriteAppBlock(sd, dbhandle, databuf, datasize):
    return _pisock.dlp_WriteAppBlock(sd, dbhandle, databuf, datasize)

def dlp_ReadSortBlock(sd, dbhandle, offset, reqbytes):
    return _pisock.dlp_ReadSortBlock(sd, dbhandle, offset, reqbytes)

def dlp_WriteSortBlock(sd, dbhandle, databuf, datasize):
    return _pisock.dlp_WriteSortBlock(sd, dbhandle, databuf, datasize)
...
def dlp_WriteRecord(sd, dbhandle, flags, recuid, catid, databuf, datasize):
    return _pisock.dlp_WriteRecord(sd, dbhandle, flags, recuid, catid, databuf, datasize)
...
def dlp_WriteResource(sd, dbhandle, restype, resid, databuf, datasize):
    return _pisock.dlp_WriteResource(sd, dbhandle, restype, resid, databuf, datasize)

def dlp_DeleteResource(sd, dbhandle, all, restype, resid):
    return _pisock.dlp_DeleteResource(sd, dbhandle, all, restype, resid)

def dlp_ExpSlotEnumerate(sd, numslots, slotrefs):
    return _pisock.dlp_ExpSlotEnumerate(sd, numslots, slotrefs)
...
def dlp_VFSFileWrite(sd, fileref, databuf, datasize):
    return _pisock.dlp_VFSFileWrite(sd, fileref, databuf, datasize)
